        ...
        <div class="row">
            <div class="col-md-12">
                <div class="shopping-cart">
                                ...
                                <div class="col-md-6 my-auto">
                                    <a href="{{url('collections/'.$wishlistItem->product->category->slug.'/'.$wishlistItem->product->slug)}}">
                                        <label class="product-name">
                                            <img src=" {{$wishlistItem->product->productImages[0]->image}}" style="width: 50%; height: 50%; object-fit:cover" alt=" {{$wishlistItem->product->name}}">
                    ...
                    @endif
                    @empty
                        <h4>No Items Added To Wishlist</h4>
                    @endforelse
